...
const articleContents = [
  ...
  },
  {
    ...
    description: 'Master asynchronous JavaScript with Promises, async/await.',
  ...
  {
    title: 'Building a Blog with Next.js 14 and MDX',
    description: 'Create a performant blog using Next.js App Router.',
    slug: 'blog-nextjs14-mdx',
    content: '# Building a Blog with Next.js 14\n\n## Setup\n\n```bash\nnpx create-next-app@latest my-blog\n```\n\n## Dynamic Routes\n\n```javascript\nexport async function generateStaticParams() {\n  const posts = getPosts();\n  return posts.map(post => ({ slug: post.slug }));\n}\n```',
    tags: ['nextjs', 'react', 'mdx', 'blog'],
    readingTime: 15,
    likes: 72,
    commentsCount: 28,
    views: 2600
  },
  {
    ...
    description: 'How to give and receive feedback that improves code.',
    slug: 'psychology-code-reviews',
    content: '# The Psychology of Code Reviews\n\n## Giving Feedback\n\n- Focus on the code, not the person\n- Ask questions instead of making demands\n\n## Receiving Feedback\n\n- It is not personal\n- Every comment is an opportunity to learn',
  ...
  {
    title: 'Introduction to Web Security for Developers',
    description: 'Understand XSS, CSRF, and how to prevent them.',
  ...
  },
  {
    ...
    content: '# Building Accessible Web Apps\n\n## Semantic HTML\n\n```html\n<button>Submit</button>\n```\n\n## ARIA Labels\n\n```html\n<button aria-label="Close menu">X</button>\n```',
  ...
  },
  {
    ...
    content: '# Best VS Code Extensions\n\n## Theme\n- Tokyo Night\n- Catppuccin\n\n## Productivity\n- GitHub Copilot\n- Todo Tree\n\n## Dev Tools\n- REST Client\n- Docker',
  ...
  },
  {
    ...
    description: 'Understand how database indexes work.',
  ...
  },
  {
    ...
    description: 'The journey from zero to employed.',
    slug: 'first-developer-job-journey',
    content: '# Landing Your First Dev Job\n\n## What Worked\n\n1. Building real projects\n2. Contributing to open source\n3. Networking on Twitter\n\n## The Interview Process\n\n- Technical assignments\n- System design discussions',
    tags: ['career', 'beginners', 'job-search'],
    readingTime: 9,
    likes: 267,
    commentsCount: 112,
    views: 9200
  },
  {
    ...
    description: 'Create your first Chrome extension.',
    slug: 'chrome-extension-tutorial',
    content: '# Chrome Extension Tutorial\n\n## Manifest File\n\n```json\n{\n  "manifest_version": 3,\n  "name": "My Extension"\n}\n```\n\n## Loading\n\nOpen chrome://extensions',
    tags: ['javascript', 'chrome-extension', 'tutorial'],
    readingTime: 13,
    likes: 59,
    commentsCount: 24,
    views: 2100
  ...
  },
  {
    ...
    description: 'Modernize your React setup.',
    slug: 'migrating-cra-to-vite',
    content: '# Migrating to Vite\n\n## Why Vite?\n\n- Faster dev server\n- Instant hot reload\n\n## Configuration\n\n```javascript\nimport { defineConfig } from "vite";\nexport default defineConfig({});\n```',
  ...
  },
  {
    ...
    description: 'Upcoming JavaScript features and trends.',
    slug: 'javascript-future-2025',
    content: '# JavaScript in 2025\n\n## TC39 Proposals\n\n- Records and Tuples\n- Pattern Matching\n\n## Framework Trends\n\n- Server Components\n- Edge rendering',
    tags: ['javascript', 'future', 'trends'],
    readingTime: 7,
    likes: 112,
    commentsCount: 48,
    views: 4100
  },
  {
    ...
    slug: 'javascript-debugging-techniques',
    content: '# Debugging JavaScript\n\n## Browser DevTools\n\n- Breakpoints\n- Watch expressions\n\n## Console Methods\n\n```javascript\nconsole.table(data);\nconsole.time("loop");\n```',
    tags: ['javascript', 'debugging', 'productivity'],
    readingTime: 10,
    likes: 76,
    commentsCount: 33,
    views: 2800
  ...
  },
  {
    ...
    description: 'Master the foundation of CSS layout.',
  ...
  },
  {
    ...
    description: 'Practical tips to make React apps fast.',
  ...
  },
  {
    ...
    description: 'Learn about graph databases.',
    slug: 'graph-databases-neo4j',
    content: '# Graph Databases\n\n## What is Neo4j?\n\nA graph database using nodes and relationships.\n\n## Cypher Query\n\n```cypher\nMATCH (p:Person)-[:WORKS_AT]->(c:Company)\n```',
  ...
  },
  {
    ...
    description: 'Create consistent UI with your own design system.',
    slug: 'design-system-from-scratch',
    content: '# Design Systems\n\n## Core Components\n\n- Colors\n- Typography\n- Spacing\n\n## Tokens\n\n```javascript\nconst tokens = { colors: { primary: "#007bff" } };\n```',
    tags: ['css', 'design', 'ui', 'components'],
    readingTime: 13,
    likes: 71,
    commentsCount: 30,
    views: 2500
  },
  {
    ...
    description: 'Understanding AWS Lambda and FaaS.',
  ...
  },
  {
    ...
    description: 'Connect Docker containers together.',
  ...
  },
  {
    ...
    content: '# ML for Web Devs\n\n## TensorFlow.js\n\n```javascript\nconst model = tf.sequential();\nmodel.add(tf.layers.dense({ units: 1 }));\n```\n\n## Use Cases\n\n- Sentiment analysis\n- Image classification',
    tags: ['javascript', 'machine-learning', 'ai'],
    readingTime: 19,
    likes: 134,
    commentsCount: 58,
    views: 4800
  },
  {
    ...
    description: 'Handle dates properly using Date and Intl.',
    slug: 'javascript-date-time-handling',
  ...
  {
    title: 'Introduction to WebSockets vs Server-Sent Events',
    description: 'Choose the right real-time method.',
    slug: 'websockets-vs-server-sent-events',
    content: '# WebSockets vs SSE\n\n## WebSockets\n\n- Bidirectional communication\n- Real-time two-way messaging\n\n## Server-Sent Events\n\n- One-way server to client\n- Automatic reconnection',
    tags: ['javascript', 'websockets', 'sse', 'realtime'],
    readingTime: 9,
    likes: 48,
    commentsCount: 19,
    views: 1700
  },
  {
    ...
    description: 'Tips for creating an impressive portfolio.',
    slug: 'portfolio-website-tips',
    content: '# Portfolio Tips\n\n## What to Include\n\n- Live projects with source code\n- Clear bio and skills\n- Contact information\n\n## Design Tips\n\n- Keep it simple\n- Make it mobile-friendly',
    tags: ['career', 'portfolio', 'webdev'],
    readingTime: 8,
    likes: 112,
    commentsCount: 45,
    views: 4100
  },
  {
    ...
    description: 'Learn about global, function, and block scope.',
    slug: 'javascript-variable-scope',
    content: '# Variable Scope in JavaScript\n\n## Global Scope\n\nVariables declared outside functions.\n\n## Block Scope\n\n```javascript\nif (true) {\n  let blockScoped = "only here";\n}\n```',
    tags: ['javascript', 'scope', 'programming'],
    readingTime: 10,
    likes: 76,
    commentsCount: 31,
    views: 2800
  },
  {
    ...
    description: 'Introduction to PostgreSQL for beginners.',
    slug: 'postgresql-beginners-guide',
  ...
  },
  {
    ...
    description: 'Create a weather application using fetch API.',
    slug: 'weather-app-javascript',
    content: '# Weather App Tutorial\n\n## API Setup\n\nUse OpenWeatherMap API.\n\n```javascript\nconst url = "https://api.openweathermap.org/data/2.5/weather";\n```\n\n## Fetch Data\n\n```javascript\nasync function getWeather(city) {\n  const res = await fetch(url);\n}\n```',
    tags: ['javascript', 'api', 'fetch', 'projects'],
    readingTime: 15,
    likes: 128,
    commentsCount: 54,
    views: 4600
  },
  {
    ...
    description: 'A complete guide to HTTP response codes.',
  ...
  },
  {
    ...
    description: 'Simplify Redux with the modern Redux Toolkit.',
    slug: 'redux-toolkit-introduction',
    content: '# Redux Toolkit\n\n## Create a Slice\n\n```javascript\nimport { createSlice } from "@reduxjs/toolkit";\n```\n\n## Configure Store\n\n```javascript\nimport { configureStore } from "@reduxjs/toolkit";\n```',
    tags: ['react', 'redux', 'redux-toolkit', 'state-management'],
    readingTime: 13,
    likes: 71,
    commentsCount: 29,
    views: 2600
