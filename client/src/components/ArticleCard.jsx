...
const ArticleCard = ({ article, onBookmarkChange, onLikeChange }) => {
  const {
    title,
    description,
    slug,
  ...
  const handleLike = async (e) => {
    ...
    try {
      ...
      if (onLikeChange) {
        onLikeChange(response.data.liked, response.data.likesCount);
      }
    } catch (error) {
      ...
      <div className="article-card-header">
        ...
        {user && (
          <div className="article-card-actions">
            <button 
              className={`article-card-like ${liked ? 'liked' : ''}`}
              onClick={handleLike}
              disabled={liking}
            ...
            >
              ...
              <span className="article-card-like-count">{likeCount}</span>
            </button>
            <button 
